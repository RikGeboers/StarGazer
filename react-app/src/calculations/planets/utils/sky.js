import { Astronomy, Angle, GeographicCoordinates } from "./astronomy";
...
const Bodies = Astronomy.Body.filter((body) =>
  ["planet", undefined].includes(body.BodyType)
);
...
export class Sky {
  constructor(opts = {}) {
    ...
    this.location = new GeographicCoordinates(
      options.longitude,
      options.latitude,
      options.elevation
    );
